/* kitclinico.com.br — cookie consent banner + Google Consent Mode v2 (GDPR/LGPD)
 * Standalone, no dependencies. Stores choice in localStorage as 'kc-consent' = 'granted' | 'denied'.
 */
(function () {
  'use strict';
  var KEY = 'kc-consent';
  ...
  function init() {
    ...
    banner.addEventListener('click', function (e) {
      ...
      document.dispatchEvent(new CustomEvent('kc:consent', { detail: { value: action } }));
    });
  }
